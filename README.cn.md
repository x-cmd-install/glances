...
![glances](https://repo.x-cmd.io/glances.svg?lang=zh)
...
合计: **61,209** 行代码（覆盖前 5 种语言、共 **323** 个文件）。
...
- **Star**: 33,551 · **Fork**: 1,804 · **开放 issue**: 2,224 · **贡献者**: 231

## 累计统计

- **发布数**: 61 · **已合并 PR**: 870 · **开放 PR**: 10 · **已关闭 issue**: 2131 · **开放 issue**: 93 · **提交数**: 7387
...
在 [repology.org](https://repology.org/project/glances) 上共有 **129** 个发行版报告此项目。**27** 个 ✅ 已是最新上游版本，**75** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T04:59:36Z._
